...
public interface DoctorRepository  extends JpaRepository<Doctor, Integer> {
	...
	@Modifying
    @Query(value="SELECT u FROM Doctor u WHERE u.specializations = :specializations")
	Optional<List<Doctor>> finBySpecializations(@Param("specializations")int specializations);

    @Query(value="SELECT u FROM Doctor u WHERE u.price = :price")
	List<Doctor> finByPrice(@Param("price")long price);
}
