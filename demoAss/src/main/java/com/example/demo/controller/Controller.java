...
import com.example.demo.modeldto.DoctorDTO;
...
import com.example.demo.services.SearchServices;
...
//	Tim kiem chung
//	////////////////////////////////////////
	@GetMapping("/public/SearchAddress")
	public ResponseEntity<SearchDTO> SearchAddress(@RequestBody SearchDTO searchDTO) {
		SearchDTO searchDTO2 = searchServices.search(searchDTO);
		return ResponseEntity.status(200).body(searchDTO);
	}

//	Tìm kiếm theo bác sĩ theo chuyên khoa 
	@GetMapping("/public/SearchSpecializations/{searchSpec}")
	public ResponseEntity<List<Doctor>> SearchSpecializations2(@PathVariable String searchSpec) {
		Optional<Specializations> specializations = specializationsService.findByNameOptional(searchSpec);
		if (specializations.isEmpty()) {
			return ResponseEntity.status(200).body(null);
		}
		List<Doctor> list = specializationsService.findByNameOptional(searchSpec).get().getDoctors();
